...
//and if it does, I increment my counter, basically calculating letters 
...
//to  and numeric value of counter next to it, which represent letter count,
//also reset counter to 1 for the next letter
	}else if (nameArray[i]==" "){continue}else{
		b.push(`Letters "${nameArray[i]}": ${counter};`);
		counter=1;
	}
}
